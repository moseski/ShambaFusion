...
param shambaFusionExists bool
@secure()
param shambaFusionDefinition object
...
module shambaFusion './app/shamba-fusion.bicep' = {
  name: 'shamba-fusion'
  params: {
    name: 'shamba-fusion'
    location: location
    tags: tags
    identityName: '${abbrs.managedIdentityUserAssignedIdentities}shamba-fusion-${resourceToken}'
    applicationInsightsName: monitoring.outputs.applicationInsightsName
    containerAppsEnvironmentName: appsEnv.outputs.name
    containerRegistryName: registry.outputs.name
    exists: shambaFusionExists
    appDefinition: shambaFusionDefinition
